...
echo ("<br /><p>The file 'framework/module.functions.php' is marked deprecated in LEPTON 2.0.0 and will be deleted in next release!.</p> <br />");
echo ("<p>Please use 'framework/summary.module_edit_css.php' instead .</p> <br />");
