...
$TEXT = array(
	...
	'MAILER_DEFAULT_SETTINGS_NOTICE' 	=> 'Specifica un indirizzo "FROM" e "SENDER". &egrave; preferibile usare un indirizzo FROM come: <strong>admin@yourdomain.com</strong>. Alcuni provider email (e.g. <em>mail.com</em>) possono rifiutare l\'indirizzo FROM: come <em>name@mail.com</em> inviato tramite un relay di spam.<br /><br />Il valore predefinito &egrave; usato solo se non ci sono altri valori specificati di LEPTON. Se il tuo server supporta <acronym title="Simple mail transfer protocol">SMTP</acronym>, puoi non usare questa opzione.',
	'MAILER_FUNCTION' 			=> 'Mail Routine',
	'MAILER_NOTICE' 			=> '<strong>SMTP Mailer Settings:</strong><br />la configurazione sottostante &egrave; richiesta se vuoi inviare via <acronym title="Simple mail transfer protocol">SMTP</acronym>. se conosci il tuo host SMTP o non sei sicuro dele impostazioni correttelascia la mail routine predefinita: PHP MAIL.',
	'MAILER_PHP' 				=> 'PHP MAIL',
	...
	'MAILER_TESTMAIL_FAILED' 		=> 'L\'eMail di test non pu&ograve; essere inviata! Verifica le tue impostazioni!',
	'MAILER_TESTMAIL_SUCCESS' 		=> 'L\'eMail di test &egrave; stata inviata con successo. Controlal la tua email.',
	'MAILER_TESTMAIL_TEXT' 		=> 'Questo &egrave; il testo dell\'email di prova : php mailer is working',
	'WEBSITE' 				=> 'Sito Web',
