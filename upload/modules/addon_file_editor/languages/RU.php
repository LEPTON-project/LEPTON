...
$module_description = 'AFE позволяет редактировать изображения и текстовые файлы установленных добавлений через панель администрирования. Ознакомьтесь с <a href="{LEPTON_URL}/modules/addon_file_editor/help/help_en.html" target="_blank">README</a> (англ.) для дополнительноый информации).';
...
$LANG[10] = array(
	...
	'TXT_FTP_LOGIN_FAILED'		=> 'Соединение с FTP невозможно. Проверьте настройки. ' .
								   '<br /><strong>Помните:</strong> параметр "начальная директория" должен указывать на папку, <br />где установлена LEPTON.',
);
