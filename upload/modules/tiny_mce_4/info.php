...
$module_description   = 'TinyMCE 4.1.5 - build date:(2014-09-09)<br>with Ajax Image File Manager and image editor<BR> allows you to edit the content of a page and see media image folder.<BR>To link your template css file to the styles in tinymce you need to edit the <b>include.php</b> file inside this module.';

/**
 *	2014-09-09	- update to 4.1.5
 *
 *	2014-08-21	- update to 4.1.4
 * 
 *	2014-07-29	- update to 4.1.3
 * 
 *	2014-07-15	- update to 4.1.2
 * 
 *	2014-07-07	- update to 4.1.1
 * 
