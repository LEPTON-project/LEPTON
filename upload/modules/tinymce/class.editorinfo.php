 ...
 *
 */	
if (file_exists( LEPTON_PATH."/modules/tinymce/class.editorinfo.custom.php")) {
	include_once( LEPTON_PATH."/modules/tinymce/class.editorinfo.custom.php");
} else {

	class editorinfo_TINYMCE
	{
		/**
